...
class CategoryEventsControllerTest < ActionController::TestCase
  ...
  test "should create category_event" do
    assert_difference('CategoryEvent.count') do
      post :create, category_event: { descCategory: @category_event.descCategory, titleCategory: @category_event.titleCategory }
    end
  ...
  test "should update category_event" do
    put :update, id: @category_event, category_event: { descCategory: @category_event.descCategory, titleCategory: @category_event.titleCategory }
    assert_redirected_to category_event_path(assigns(:category_event))
  end
