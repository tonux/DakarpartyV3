...
class PartenairesControllerTest < ActionController::TestCase
  ...
  test "should create partenaire" do
    assert_difference('Partenaire.count') do
      post :create, partenaire: { descPartenaire: @partenaire.descPartenaire, email: @partenaire.email, nomPartenaire: @partenaire.nomPartenaire, telephone: @partenaire.telephone }
    end
  ...
  test "should update partenaire" do
    put :update, id: @partenaire, partenaire: { descPartenaire: @partenaire.descPartenaire, email: @partenaire.email, nomPartenaire: @partenaire.nomPartenaire, telephone: @partenaire.telephone }
    assert_redirected_to partenaire_path(assigns(:partenaire))
  end
